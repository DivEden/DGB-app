...
requirements = python3,kivy,requests,cython==0.29.33
...
icon.filename = %(source.dir)s/museum_search_app/utils/Images/Icon.png
...
# Build for both arm64 and armv7a for maximum compatibility
...
# Get a list of available identities: Xcode-select --install then security find-identity -v -p codesigning
